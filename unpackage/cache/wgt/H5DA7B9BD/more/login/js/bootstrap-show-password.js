...
!function ($) {
    ...
    Password.DEFAULTS = {
        ...
        eyeClass: 'iconfont xian-mi',
        eyeOpenClass: 'icon-icon-test',
        eyeCloseClass: 'icon-close-eye',
    ...
    Password.prototype.init = function() {
        ...
        this.$icon = $([
            ...
            '<i class="icon-icon-test' + (this.options.white ? 'iconfont' : '') +
    ...
    Password.prototype.show = function(_relatedTarget) {
        ...
        if (this.options.eyeClassPositionInside) {
            this.$icon.find('i')
                .removeClass('icon-icon-test')
                .addClass('icon-close-eye')
                .html(this.options.eyeCloseClass);
        } else {
            this.$icon.find('i')
                .removeClass('icon-icon-test ' + this.options.eyeOpenClass)
                .addClass('icon-close-eye ' + this.options.eyeCloseClass);
        }
    ...
    Password.prototype.hide = function(_relatedTarget) {
        ...
        if (this.options.eyeClassPositionInside) {
            this.$icon.find('i')
                .removeClass('icon-close-eye')
                .addClass('icon-icon-test')
                .html(this.options.eyeOpenClass);
        } else {
            this.$icon.find('i')
                .removeClass('icon-close-eye ' + this.options.eyeCloseClass)
                .addClass('icon-icon-test ' + this.options.eyeOpenClass);
        }
