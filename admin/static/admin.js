...
function goPage(page) {
    wikiData = page
    document.getElementById('wiki_group').innerHTML = `<nav class="navbar navbar-expand-lg bg-body-tertiary"><div onclick="wikiIndex()" class="container"><a class="navbar-brand"href="#"><img id="no_img" src="./static/return.svg"alt="Bootstrap"width="30"height="24"></a></div></nav>`
    $.ajax({
...
function toWz(w, z) {
    document.getElementById('wiki_group').innerHTML = `<nav class="navbar navbar-expand-lg bg-body-tertiary"><div onclick="goPage('${w}')" class="container"><a class="navbar-brand"href="#"><img id="no_img" src="./static/return.svg"alt="Bootstrap"width="30"height="24"></a></div></nav>`
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.message == "success") {
                for (var i = 0; i < res.main.length; i++) {
                    ...
                    <tr id="GGmainBox${res.main[i].Id}"><td><div class="recommend_list_box"id="GGbox${res.main[i].Id}"><div class="box_top"><!--<div class="box_top_line"></div>--><img id="no_img" class="box_top_linesvg"src="./static/gg.svg"alt=""srcset=""><div><p class="line_p">新公告：${res.main[i].Title}</p></div></div><div style="padding: 20px;">${res.main[i].Main}</div></div></td><td><button type="button"class="btn btn-outline-danger" onclick="delGG(${res.main[i].Id})">删除</button></td></tr>
                    `)
                }
            } else {
                err("e", res.message)
